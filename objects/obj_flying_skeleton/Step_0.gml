...
//		scr_enemy_attack(-1,true,attack1Duration,0,0,10,22,1,physicalPower*1,6,20,-1,0,0); 
//	//@scr_enemy_attack(-1,true,dur,xOff,yOff,width,height,damType,dam,stagger,knockback,statType,statValue,pierce)
//	}
...
//	{
//		scr_enemy_attack(-1,true,0.2,16,0,16,16,1,physicalPower*1.25,6,15,-1,0,0); 
//		//@scr_enemy_attack(-1,true,dur,xOff,yOff,width,height,damType,dam,stagger,knockback,statType,statValue,pierce)
//	}
//	if deflected && subPhase == "attacking"
//	{
