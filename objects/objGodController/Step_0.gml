switch phase
{
	case godControllerState.mainMenu:
		if !instance_exists(objCamera) instance_create_depth(0,0,0,objCamera);
		if !instance_exists(inputManager) instance_create_depth(0,0,0,inputManager);
		if !instance_exists(objMainMenu) instance_create_depth(0,0,0,objMainMenu);
		break;
	case godControllerState.inGame:
		if !instance_exists(objCamera) instance_create_depth(0,0,0,objCamera);
		if !instance_exists(inputManager) instance_create_depth(0,0,0,inputManager);
		if !instance_exists(objEffectsController) instance_create_depth(0,0,0,objEffectsController);
		if !instance_exists(playerData) instance_create_depth(0,0,0,playerData);
		break;
	case godControllerState.arena:
		if !instance_exists(objCamera) instance_create_depth(0,0,0,objCamera);
		if !instance_exists(inputManager) instance_create_depth(0,0,0,inputManager);
		if !instance_exists(objEffectsController) instance_create_depth(0,0,0,objEffectsController);
		if !instance_exists(playerData) instance_create_depth(0,0,0,playerData);
		if !instance_exists(objArenaController) instance_create_depth(0,0,0,objArenaController);
}
