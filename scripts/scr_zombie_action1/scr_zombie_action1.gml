...
switch subPhase
{
	case subState.actionSub1:
		...
		{
			scr_enemy_attack(attack1HitDuration,attack1XOffset,attack1YOffset,attack1Width,attack1Height,attack1DamageType,attack1Damage*statCache.damagePower,attack1Stagger*statCache.staggerPower,attack1Knockback,attack1StatusType,attack1StatusValue,attack1Pierce)
		}
