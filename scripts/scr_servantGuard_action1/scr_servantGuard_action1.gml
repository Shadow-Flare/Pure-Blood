...
else switch subPhase
{
	case subState.actionSub1:
		...
		{
			scr_enemy_attack(action1FrameData,action1Follow,action1HitDuration,action1DamageType,action1Damage*statCache.damagePower,action1Stagger*statCache.staggerPower,action1Knockback,action1StatusType,action1StatusValue,action1Pierce,action1Animation,action1SoundID);
