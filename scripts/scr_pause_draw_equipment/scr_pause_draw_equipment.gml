...
for(var i = 0; i < 360; i += 360/maxRunes)
{
	...
	var centerX = equipmentRunesCenterX+dcos(angle)*equipmentRunesRadius;
	var centerY = equipmentRunesCenterY-dsin(angle)*equipmentRunesRadius;
	var distX = equipmentRunesWidth/2;
	var distY = equipmentRunesHeight/2;
	...
	xGap = ((equipmentHeadX2-equipmentHeadX1)-equipmentIconScale*sprite_get_width(sprite))/2;
	yGap = ((equipmentHeadY2-equipmentHeadY1)-equipmentIconScale*sprite_get_height(sprite))/2;
...
scr_draw_textbox(equipmentHeadX1,equipmentHeadY1,equipmentHeadX2,equipmentHeadY2,equipmentHeadType,equipmentHeadScale,col);

if selection == equipmentSlot.chest {col = equipmentSelectionColour; draw_set_alpha(1);}
else {col = equipmentHeadColour; draw_set_alpha(equipmentSurfaceMainAlpha);}
scr_draw_textbox(equipmentChestX1,equipmentChestY1,equipmentChestX2,equipmentChestY2,equipmentChestType,equipmentChestScale,col);

if selection == equipmentSlot.legs {col = equipmentSelectionColour; draw_set_alpha(1);}
else {col = equipmentHeadColour; draw_set_alpha(equipmentSurfaceMainAlpha);}
scr_draw_textbox(equipmentLegsX1,equipmentLegsY1,equipmentLegsX2,equipmentLegsY2,equipmentLegsType,equipmentLegsScale,col);

if selection == equipmentSlot.main1 {col = equipmentSelectionColour; draw_set_alpha(1);}
else {col = equipmentHeadColour; draw_set_alpha(equipmentSurfaceMainAlpha);}
scr_draw_textbox(equipmentMain1X1,equipmentMain1Y1,equipmentMain1X2,equipmentMain1Y2,equipmentMain1Type,equipmentMain1Scale,col);

if selection == equipmentSlot.main2 {col = equipmentSelectionColour; draw_set_alpha(1);}
else {col = equipmentHeadColour; draw_set_alpha(equipmentSurfaceMainAlpha);}
scr_draw_textbox(equipmentMain2X1,equipmentMain2Y1,equipmentMain2X2,equipmentMain2Y2,equipmentMain2Type,equipmentMain2Scale,col);

if selection == equipmentSlot.off1 {col = equipmentSelectionColour; draw_set_alpha(1);}
else {col = equipmentHeadColour; draw_set_alpha(equipmentSurfaceMainAlpha);}
scr_draw_textbox(equipmentOff1X1,equipmentOff1Y1,equipmentOff1X2,equipmentOff1Y2,equipmentOff1Type,equipmentOff1Scale,col);

if selection == equipmentSlot.off2 {col = equipmentSelectionColour; draw_set_alpha(1);}
else {col = equipmentHeadColour; draw_set_alpha(equipmentSurfaceMainAlpha);}
scr_draw_textbox(equipmentOff2X1,equipmentOff2Y1,equipmentOff2X2,equipmentOff2Y2,equipmentOff2Type,equipmentOff2Scale,col);
	#endregion
	...
	if sprite == undefined sprite = spr_icon_item_undefined;
	draw_sprite_ext(sprite,0,equipmentHeadX1+xGap,equipmentHeadY1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	draw_sprite_ext(sprite,0,equipmentChestX1+xGap,equipmentChestY1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	if sprite == undefined sprite = spr_icon_item_undefined;
	draw_sprite_ext(sprite,0,equipmentLegsX1+xGap,equipmentLegsY1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	if sprite == undefined sprite = spr_icon_item_undefined;
	draw_sprite_ext(sprite,0,equipmentMain1X1+xGap,equipmentMain1Y1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	draw_sprite_ext(sprite,0,equipmentMain2X1+xGap,equipmentMain2Y1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	draw_sprite_ext(sprite,0,equipmentOff1X1+xGap,equipmentOff1Y1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	if sprite == undefined sprite = spr_icon_item_undefined;
	draw_sprite_ext(sprite,0,equipmentOff2X1+xGap,equipmentOff2Y1+yGap,equipmentIconScale,equipmentIconScale,0,c_white,a);
	...
	for (var i = 0; i < 4; i++)
	{
		...
		var textX = equipmentItemCenterX-equipmentItemWidth/2+(i-1.5)*equipmentItemHorSep;
		var textY = equipmentItemCenterY-equipmentItemHeight/2;
		if sY == i && selection == equipmentSlot.item col = equipmentSelectionColour;
		draw_set_alpha(a);
		scr_draw_textbox(textX,textY,textX+equipmentItemWidth,textY+equipmentItemHeight,equipmentItemType,equipmentItemScale,col);
	}
	draw_set_alpha(1);
	#endregion
	...
	xGap = ((equipmentItemWidth)-equipmentIconScale*sprite_get_width(sprite))/2;
	yGap = ((equipmentItemHeight)-equipmentIconScale*sprite_get_height(sprite))/2;
	...
	for (var i = 0; i < 4; i++)
	{
		...
		if sprite == undefined sprite = spr_icon_item_undefined;
		iconX = equipmentItemCenterX-equipmentItemWidth/2+(i-1.5)*equipmentItemHorSep+xGap;
		iconY = equipmentItemCenterY-equipmentItemHeight/2+yGap;
...
draw_clear_alpha(c_black,0);
	#region Info Text Boxes
		//Player Stats
	scr_draw_textbox(equipmentPlayerStatsX1,equipmentPlayerStatsY1,equipmentPlayerStatsX2,equipmentPlayerStatsY2,equipmentPlayerStatsType,equipmentPlayerStatsScale,equipmentPlayerStatsColour);
		//item Stats
	scr_draw_textbox(equipmentItemStatsX1,equipmentItemStatsY1,equipmentItemStatsX2,equipmentItemStatsY2,equipmentItemStatsType,equipmentItemStatsScale,equipmentItemStatsColour);
	#endregion
	#region Info Data: Player Stats
		...
		#endregion
		//title && page
	var textSep = ((equipmentPlayerStatsTextColumn1Y2-equipmentPlayerStatsTextColumn1Y1)-string_height(""))/equipmentPlayerStatsTextEntries;
	var col;
	var index = 0;
	draw_set_font(fnt_menu);
	draw_set_colour(c_white);
	draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Character Status");
	draw_set_halign(fa_right);
	draw_text(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,"Page "+string(equipmentPlayerStatsPage+1));
	draw_set_halign(fa_left);
	index++;
	switch equipmentPlayerStatsPage
	{
		case 0: #region Page 1: HP, MP, AP and Attributes
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Health"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Mana"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Ability Points"); index++;
			index++;	//empty space
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Strength"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Constitution"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Dexterity"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Cunning"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Intelligence"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Willpower"); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_hpMax)),col,col,col,col,1.0); index++;
			
			if _mpMax == PlayerStats.mpMax col = c_white;
			else if _mpMax > PlayerStats.mpMax col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_mpMax)),col,col,col,col,1.0); index++;
			
			if _apMax == PlayerStats.apMax col = c_white;
			else if _apMax > PlayerStats.apMax col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_apMax)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(_strength),col,col,col,col,1.0); index++;
			
			if _constitution == PlayerStats.constitution col = c_white;
			else if _constitution > PlayerStats.constitution col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(_constitution),col,col,col,col,1.0); index++;
			
			if _dexterity == PlayerStats.dexterity col = c_white;
			else if _dexterity > PlayerStats.dexterity col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(_dexterity),col,col,col,col,1.0); index++;
			
			if _cunning == PlayerStats.cunning col = c_white;
			else if _cunning > PlayerStats.cunning col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(_cunning),col,col,col,col,1.0); index++;
			
			if _intelligence == PlayerStats.intelligence col = c_white;
			else if _intelligence > PlayerStats.intelligence col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(_intelligence),col,col,col,col,1.0); index++;
			
			if _willpower == PlayerStats.willpower col = c_white;
			else if _willpower > PlayerStats.willpower col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(_willpower),col,col,col,col,1.0); index++;
			
			draw_set_halign(fa_left);
			
			break; #endregion
		case 1: #region Page 2: Alacrity, Damage+Force and toughnesses.
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Alacrity"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Memory"); index++;
			index++;	//empty space
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Physical Power"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Physical Force"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Physical Toughness"); index++;
			index++;	//empty space
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Magical Power"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Magical Force"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Magical Toughness"); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_alacrity)),col,col,col,col,1.0); index++;
			
			if _memory == PlayerStats.memory col = c_white;
			else if _memory > PlayerStats.memory col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_memory)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_physicalPower)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_physicalStagger)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_physicalToughness)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_magicalPower)),col,col,col,col,1.0); index++;
			
			if _magicalStagger == PlayerStats.magicalStagger col = c_white;
			else if _magicalStagger > PlayerStats.magicalStagger col = c_green;
			else col = c_red;
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_magicalStagger)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_magicalToughness)),col,col,col,col,1.0); index++;
			
			draw_set_halign(fa_left);
			
			break; #endregion
		case 2: #region Page 3: Physical Defences and Elemental Resistances
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Physical Defence"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Slash Defence"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Blunt Defence"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Pierce Defence"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Fire Resistance"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Ice Resistance"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Lightning Resistance"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Arcane Resistance"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Light Resistance"); index++;
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Dark Resistance"); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_physicalDefense)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_slash)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_pierce)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_blunt)),col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_fire*100-100))+"%",col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_ice*100-100))+"%",col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_lightning*100-100))+"%",col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_arcane*100-100))+"%",col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_light*100-100))+"%",col,col,col,col,1.0); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_damageResistances_dark*100-100))+"%",col,col,col,col,1.0); index++;
			
			draw_set_halign(fa_left);
			
			break; #endregion
		case 3: #region Page 4: Special Defenses and Misc (Not fully filled yet)
			draw_text(equipmentPlayerStatsTextColumn1X,equipmentPlayerStatsTextColumn1Y1+index*textSep,"Bleed Resistance"); index++;
			...
			draw_text_color(equipmentPlayerStatsTextColumn2X,equipmentPlayerStatsTextColumn2Y1+index*textSep,string(round(_specialResistances_bleed)),col,col,col,col,1.0); index++;
	...
	{		
		...
		if text != undefined
		{
			draw_text(equipmentItemStatsX1+equipmentItemStatsTextBorderGap+equipmentItemStatsTextHorizontalSeparation*i,equipmentItemStatsY1+equipmentItemStatsTextBorderGap+equipmentItemStatsTextVerticalSeparation*j,text)
			j++;
		}
		index++;
...
surface_set_target(equipmentSurfaceSlot);
	...
	#region Selection Textbox Back
		...
		{
			case equipmentSlot.head:
				iconX = equipmentHeadX1;
				iconY = equipmentHeadY1;
				scr_draw_textbox(equipmentHeadX1,equipmentHeadY1,equipmentHeadX2,equipmentHeadY2,equipmentHeadType,equipmentHeadScale,equipmentSelectionColour);
				break;
			case equipmentSlot.chest:
				iconX = equipmentChestX1;
				iconY = equipmentChestY1;
				scr_draw_textbox(equipmentChestX1,equipmentChestY1,equipmentChestX2,equipmentChestY2,equipmentChestType,equipmentChestScale,equipmentSelectionColour);
				break;
			case equipmentSlot.legs:
				iconX = equipmentLegsX1;
				iconY = equipmentLegsY1;
				scr_draw_textbox(equipmentLegsX1,equipmentLegsY1,equipmentLegsX2,equipmentLegsY2,equipmentLegsType,equipmentLegsScale,equipmentSelectionColour);
				break;
			case equipmentSlot.main1:
				iconX = equipmentMain1X1;
				iconY = equipmentMain1Y1;
				scr_draw_textbox(equipmentMain1X1,equipmentMain1Y1,equipmentMain1X2,equipmentMain1Y2,equipmentMain1Type,equipmentMain1Scale,equipmentSelectionColour);
				break;
			case equipmentSlot.main2:
				iconX = equipmentMain2X1;
				iconY = equipmentMain2Y1;
				scr_draw_textbox(equipmentMain2X1,equipmentMain2Y1,equipmentMain2X2,equipmentMain2Y2,equipmentMain2Type,equipmentMain2Scale,equipmentSelectionColour);
				break;
			case equipmentSlot.off1:
				iconX = equipmentOff1X1;
				iconY = equipmentOff1Y1;
				scr_draw_textbox(equipmentOff1X1,equipmentOff1Y1,equipmentOff1X2,equipmentOff1Y2,equipmentOff1Type,equipmentOff1Scale,equipmentSelectionColour);
				break;
			case equipmentSlot.off2:
				iconX = equipmentOff2X1;
				iconY = equipmentOff2Y1;
				scr_draw_textbox(equipmentOff2X1,equipmentOff2Y1,equipmentOff2X2,equipmentOff2Y2,equipmentOff2Type,equipmentOff2Scale,equipmentSelectionColour);
				break;
			case equipmentSlot.rune:
				iconX = equipmentRunesCenterX-equipmentRunesWidth/2;
				iconY = equipmentRunesCenterY-equipmentRunesRadius-equipmentRunesHeight/2;
				scr_draw_textbox(iconX,iconY,iconX+equipmentRunesWidth,iconY+equipmentRunesHeight,equipmentRunesType,equipmentRunesScale,equipmentSelectionColour);
				break;
			case equipmentSlot.item:
				iconX = equipmentItemCenterX-equipmentItemWidth/2+(sY-1.5)*equipmentItemHorSep;
				iconY = equipmentItemCenterY-equipmentItemHeight/2;
				scr_draw_textbox(iconX,iconY,iconX+equipmentItemWidth,iconY+equipmentItemHeight,equipmentItemType,equipmentItemScale,equipmentSelectionColour);
				break;
		}
	#endregion
	#region Other Items
		for(var i = 0; i < ds_list_size(equipmentSlotCache); i++)
		{
			...
			if abs(step) <= equipmentSlotNum + 1
			{
				...
				{
					var drawX = iconX+xGap+step*equipmentSlotSep;
					var drawY = iconY+yGap;
				}
				else
				{
					var drawX = iconX+xGap;
					var drawY = iconY+yGap+step*equipmentSlotSep;
				}
	...
	#region Active Indicator
		if equipmentSlotActiveItem != noone
		{
			...
			var xGap = ((equipmentHeadX2-equipmentHeadX1)-equipmentIconScale*sprite_get_width(sprite))/2;
			var yGap = ((equipmentHeadY2-equipmentHeadY1)-equipmentIconScale*sprite_get_height(sprite))/2;
			if equipmentSlotTypeIsHor
			{
				var drawX = iconX+xGap+step*equipmentSlotSep;
				var drawY = iconY+yGap;
...
surface_reset_target();
	...
	var fadePerSec = fadeAmount/(equipmentFadeDuration*room_speed);
	if selection == equipmentSlot.rune
	{
		equipmentSurfaceMainAlpha = clamp(equipmentSurfaceMainAlpha-fadePerSec/2,1-(1-equipmentSurfaceMinAlpha)/2,1);
		if !slotExpanded equipmentSurfaceRunesAlpha = clamp(equipmentSurfaceRunesAlpha+fadePerSec,1-(1-equipmentSurfaceMinAlpha)/2,1);
		else equipmentSurfaceRunesAlpha = clamp(equipmentSurfaceRunesAlpha-fadePerSec,equipmentSurfaceMinAlpha,1);
		draw_surface_ext(equipmentSurfaceMain,0,0,1,1,0,c_white,1);
		draw_surface_ext(equipmentSurfaceRunes,0,0,1,1,0,c_white,1);
	}
	else
	{
		equipmentSurfaceRunesAlpha = clamp(equipmentSurfaceRunesAlpha-fadePerSec/2,1-(1-equipmentSurfaceMinAlpha)/2,1);
		if !slotExpanded equipmentSurfaceMainAlpha = clamp(equipmentSurfaceMainAlpha+fadePerSec/2,1-(1-equipmentSurfaceMinAlpha)/2,1);
		else equipmentSurfaceMainAlpha = clamp(equipmentSurfaceMainAlpha-fadePerSec/2,1-(1-equipmentSurfaceMinAlpha)/2,1);
		draw_surface_ext(equipmentSurfaceRunes,0,0,1,1,0,c_white,1);
		draw_surface_ext(equipmentSurfaceMain,0,0,1,1,0,c_white,1);
	}
	
	equipmentSurfaceInfoAlpha = clamp(equipmentSurfaceInfoAlpha+fadePerSec,equipmentSurfaceMinAlpha,1);
